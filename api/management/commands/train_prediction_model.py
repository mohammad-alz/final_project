...
def train_and_save_model(horizon_name, X, y):
    ...
    # Make a prediction for the most recent data
    ...
    pred_obj, _ = PricePrediction.objects.update_or_create(
        ...
        defaults={
            ...
            'model_accuracy': model.score(X, y) # Simplified accuracy for example
        }
    )
